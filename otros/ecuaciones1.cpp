...
void resolver (double resol[N-1][N]){
    printf("\n");
    printf("%2.2lf + %2.2lf = %2.2lf\n", resol[0][0], resol[0][1], resol[0][2]);
    printf("%2.2lf + %2.2lf = %2.2lf\n", resol[1][0], resol[1][1], resol[1][2]);

    resol[0][0] = resol[0][0] * resol[0][2];
    resol[1][0] = resol[1][0] * resol[0][2];
    resol[0][1] = resol[0][1] * resol[1][2];
    resol[1][1] = resol[1][1] * resol[1][2];
